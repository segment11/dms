...
String signingKey = super.binding.getProperty('signingKey')
...
DSN="${user}:${password}@tcp(${host}:${port})/n9e_v6?charset=utf8mb4&parseTime=True&loc=Local&allowNativePasswords=true"
